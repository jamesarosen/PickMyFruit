...
| A completed transfer | `Gathering` | (TBD) | Echoes French *cueillette* (picking/gathering). Works for all fulfillment modes (pickup, delivery, porch drop). Community-oriented without implying transaction. |
...
2. **French *cueillette*** directly inspired **Gathering**—emphasizes the act of coming to pick/collect
