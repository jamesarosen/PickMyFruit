...
export default defineConfig({
	...
	webServer: [
		{
			// Server-side geocoding (src/lib/geocoding.server.ts) cannot be
			// intercepted by Playwright's network routing; the app's NOMINATIM_URL
			// points at this local mock instead.
			command: 'node tests/e2e/nominatim-mock-server.mjs',
