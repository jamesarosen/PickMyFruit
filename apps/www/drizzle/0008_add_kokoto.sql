CREATE TABLE `_dc_workflow` (
	...
	`worker_pool` text DEFAULT 'node-default' NOT NULL,
	`queue` text,
...
--> statement-breakpoint
CREATE INDEX `_dc_workflow_status_scheduled_created_idx` ON `_dc_workflow` (`status`, `scheduled_for`, `created_at`);
--> statement-breakpoint
CREATE INDEX `_dc_workflow_queue_status_scheduled_idx` ON `_dc_workflow` (`queue`, `status`, `scheduled_for`);
--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `_dc_meta` (`key`, `value`) VALUES ('last_full_integrity_check_ms', '0');
